module github.com/primandproper/primitives-conformance/generator

go 1.27.1

require github.com/primandproper/primitives-go/v2 v2.0.0
...
// The generator reads behaviour out of a working tree rather than a tagged
// release, so vectors can be regenerated against unreleased changes before they
// ship. Point this at your checkout.
